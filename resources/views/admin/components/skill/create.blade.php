                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="mb-4 col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="skill_name" value="{{ old('skill_name') }}" placeholder="Skill Name">
                                    </div>
                                    <div class="mb-4 col-md-6">
                                        <label class="form-label">Percentage</label>
                                        <input type="text" class="form-control" name="score" value="{{ old('score') }}" placeholder="Skill Percentage..">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-4 col-md-6">
